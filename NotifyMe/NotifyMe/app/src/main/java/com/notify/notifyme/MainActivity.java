...
public class MainActivity extends AppCompatActivity
{
    ...
    public void onResume()
    {
        ...
        checkIdPermission();
        permtext.setText("Permissions write "+mWritePermissionGranted+", location "+mLocationPermissionGranted+", id "+mIdPermissionGranted);
        Log.e("IS SERVICE RUNNING", "result: "+isMyServiceRunning(MyNotifService.class));
    }
