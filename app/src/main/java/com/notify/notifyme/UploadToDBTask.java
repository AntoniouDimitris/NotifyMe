...
public class UploadToDBTask extends AsyncTask<String, Void, Boolean> {

    private Context ctx;
    private String tag = "Uploader";
    private UploadDataReceiver callingservice;

    public UploadToDBTask(Context con, UploadDataReceiver ns)
    {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        String upLoadServerUri = "http://150.140.15.50/elton/receivedb.php";
        ...
        try {
            ...
            if (sourceFile.isFile()) {
                ...
                try {
                    ...
                    if (serverResponseCode == 200 && serverResponseMessage.indexOf("400")!=0) {
    ...
    protected void onPostExecute(Boolean result)
    {
        ...
        if (result)
        {
            ...
            if(callingservice!=null) {
                callingservice.onUploadCompleted(result, false);
            }
            else
            {
                //nothing
